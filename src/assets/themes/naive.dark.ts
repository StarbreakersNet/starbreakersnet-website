import commonTheme from "@/assets/themes/naive.common.ts";
...
export default <GlobalThemeOverrides>{
  ...
  common: {
    ...
    baseColor: "#fff",
    primaryColor: "#bd0000",
    primaryColorHover: "#fe1010",
    primaryColorPressed: "#c11010",
    primaryColorSuppl: "#5e0808",
    infoColor: "#2295ce",
    infoColorHover: "#31a4dd",
    infoColorPressed: "#2f7ca2",
    infoColorSuppl: "#225277",
    successColor: "#63e2b7",
